...
const WhyChooseUs = () => {
  const reasons = [
    {
      id: 1,
      icon: <FaHandshake className="text-4xl text-blue-400 mb-3" />,
    ...
    {
      id: 2,
      icon: <FaShieldAlt className="text-4xl text-blue-400 mb-3" />,
  ...
  return (
    <section className="bg-black text-gray-300 py-16 px-6 md:px-12 text-center mt-8">
